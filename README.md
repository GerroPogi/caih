# College Artificial Intelligence Helper (CAIH)

## What is CAIH?
It is a tool designed to help college exam takers to prepare for their College Admission Tests. 
...
#### Mac and Linux
Setup your Python environment by running `python -m venv .venv` and **activate** it by doing `source .venv/bin/activate`
...
![Video on how to submit the reviewer](assets/new_reviewer.webm)